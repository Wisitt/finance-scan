  ...
  return (
    ...
    >
      <TabsList className="grid grid-cols-2 w-full h-12 p-1 bg-muted/50 relative">
        ...
        <motion.div
          className="absolute inset-1 rounded-md shadow-sm z-0"
          layoutId="active-tab"
        ...
        <TabsTrigger
          ...
          className={cn(
            ...
            value === 'expense' ? "text-accent" : "hover:bg-muted/80"
          )}
        >
          <motion.div
            ...
            <div className="relative">
              <ArrowDownCircle
                className={cn(
                  ...
                  value === 'expense' ? "text-accent" : "hover:bg-muted/100"
                )}
              />
        ...
        <TabsTrigger
          ...
          className={cn(
            "transition-all duration-300 rounded-md z-10 relative overflow-hidden",
            value === 'income' ? "text-primary" : "hover:bg-muted/100"
          )}
        >
          <motion.div
            className="flex items-center gap-2 font-medium"
